...
let IndustryService = class IndustryService {
    constructor(industryModel) {
        this.industryModel = industryModel;
    }
    async addIndustry(createIndustryDTO) {
    ...
    async editIndustry(industryID, createIndustryDTO) {
...
IndustryService = __decorate([
    ...
    __param(0, (0, mongoose_2.InjectModel)('Industry')),
